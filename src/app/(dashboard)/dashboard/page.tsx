    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-24">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500" style={{ ...poppins, fontWeight: 500 }}>Loading your courses…</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen pt-24 px-6">
        <div className="max-w-4xl mx-auto text-center py-20">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:shadow-lg transition-all hover:scale-105"
            style={{ ...poppins, fontWeight: 600 }}
          >
            ...
            return (
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div className={`w-full md:w-2 bg-gradient-to-b ${gradient} flex-shrink-0`} />
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white text-sm hover:shadow-lg transition-all hover:scale-[1.02] active:scale-95"
                          style={{ ...poppins, fontWeight: 600 }}
                        >
